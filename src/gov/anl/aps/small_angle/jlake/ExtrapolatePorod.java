 ...
 *
 */
public class ExtrapolatePorod extends ExtrapolateFunction {
	 ...
	 * @param qStart
	 */
	public ExtrapolatePorod(double[] Qsas, double[] Isas, double[] Idev, double qStart) {
	...
	/**
	 * Porod law extrapolationevaluated by fit 
	 * @param qNow
	 * @return extrapolated value
	 */
	public double valueOf(double qNow)
	{
		return getBackground() + getPorodConstant() / Math.pow(qNow, 4); 
	}
	...
	public static void main(String[] args) {
		...
		ExtrapolatePorod fit = new ExtrapolatePorod(Qsas, Isas, Idev, 0.031);
		System.out.println("Cp:\t" + fit.getConstant());
		System.out.println("background:\t" + fit.getSlope());
