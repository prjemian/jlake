 ...
 *
 */
public class ExtrapolateConstant extends ExtrapolateFunction {

	/**
	 * Extrapolation function used to extend SAS data for smearing <br />
	 * I(Q) = constant
	 */
	public ExtrapolateConstant() {
		super();
	}
	 ...
	 */
	public ExtrapolateConstant(double[] Qsas, double[] Isas, double[] Idev, double qStart) {
	...
	public String equation() {
		return "I(Q) = " + String.valueOf(super.getConstant());
	}
...
//	<enumeration value="Porod law"></enumeration>
	...
	public static void main(String[] args) {
		...
		ExtrapolateConstant fit = new ExtrapolateConstant(Qsas, Isas, Idev, 0.1);
