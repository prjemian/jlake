...
public class ExtrapolateFunction {
	...
	private static double  constant;		// constant coefficient of data fit
	private static double  slope;			// slope coefficient of data fit
	 ...
	 * @param Isas
	 * @param Idev
	 * @param qStart  only use Qsas[i] >= qStart
	 */
	public ExtrapolateFunction(double[] Qsas, double[] Isas, double[] Idev, double qStart)
	{
	...
	/**
	 * flat background evaluated by fit 
	 * @param qNow
	 * @return extrapolated value
	 */
	public double valueOf(double qNow)
	{
		return constant;	// ignore qNow
	}
	...
	public String equation() {
		return "I(Q) = 0 (superclass of polymorphic function)";
	}
...
//	<enumeration value="Porod law"></enumeration>
	...
	public static void main(String[] args) {
		...
		ExtrapolateFunction fit = new ExtrapolateFunction(Qsas, Isas, Idev, 0.1);
