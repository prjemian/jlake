 ...
 *
 */
public class ExtrapolateLinear extends ExtrapolateFunctionBase {
	...
	public void fitData(double[] Qsas, double[] Isas, double[] Idev, double qStart) {
		...
		setConstant(sr.lr_constant());
		setSlope(sr.lr_slope());
	}
	...
	public double valueOf(double qNow) {
		return getConstant() + qNow * getSlope();
	}
	...
	public String toString() {
		return "I(Q) = " 
			+ String.valueOf(getConstant()) 
			+ " + Q * (" 
			+ String.valueOf(getSlope()) 
			+ ")";
	}
	...
	public static void main(String[] args) {
		...
		ExtrapolateLinear fit = new ExtrapolateLinear();
