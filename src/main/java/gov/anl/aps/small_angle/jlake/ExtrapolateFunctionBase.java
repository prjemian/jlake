 ...
 * I(Q) = 0.0 <br />
 * It is expected that new classes will extend this base class.
 *
 */
public class ExtrapolateFunctionBase implements ExtrapolateInterface {

	private double  constant;		// constant coefficient of data fit
	private double  slope;			// slope coefficient of data fit

	public ExtrapolateFunctionBase() {
		setConstant(0.0);
		setSlope(0.0);
	}
	...
	/**
	 * extrapolation is a flat background (ignore qNow value)
	...
	public String toString() {
		return "I(Q) = " + String.valueOf(getConstant());
	}
	...
	/**
	 * @param newConstant the constant to set
	 */
	...
	public static void main(String[] args) {
		...
		ExtrapolateFunctionBase fit = new ExtrapolateFunctionBase();
